...
import { Button } from "@/components/ui/button"
import { Play } from "lucide-react"
import { fetchGames } from "@/lib/api" // Importing the API function to fetch real data
import { FeaturedGamesSkeleton } from "@/components/skeletons"

// Fetch the real data using async function
async function FeaturedGamesContent() {
  const games = await fetchGames() // Use the real API function to fetch games
