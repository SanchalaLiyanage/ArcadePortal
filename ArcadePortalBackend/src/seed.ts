...
const popularPokiGames = [
  ...
  },
  {
    ...
    thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=204,height=204,fit=cover,f=auto/ce4a204b6d2cc99d1879da0b2282b0d8.png",
    category: "Adventure",
...

    {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=408,height=408,fit=cover,f=auto/9f92075d9b3287fc20559277effeb719.jpeg",
        category: "Arcade",
        description: "Sweet World is a matching game created by TapLabGames. Get ready for a sweet journey that takes place in a magical candy land!"
    },

  {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=204,height=204,fit=cover,f=auto/ba4b2c2352cae3e81e1870c0c3a4adab.png",
        category: "Arcade",
        description: "Anime Dress Up is the ultimate dress-up game for creating the cutest anime girl look! Let your imagination run wild as you customize everything—from eye shape and skin color to hairstyles and outfits."
    },

  {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=204,height=204,fit=cover,f=auto/ac690395801a515782509bc69fec6db9.jfif",
        category: "Arcade",
        description: "Urban Racer is an open-world driving adventure where the city is your playground! Speed through busy downtown streets, drift along sandy beaches, and race past lively shopping districts as you take on thrilling missions."
  },

  {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=408,height=408,fit=cover,f=auto/9c9e529b14731be871b07b89660bbc2a.png",
        category: "Arcade",
        description: "Smash Karts is a 3D driving game where the objective is to collect surprise boxes and survive using whatever you find in them: Bullets, grenades, even rockets?"
    },

  {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=204,height=204,fit=cover,f=auto/649f916152c6defac7c09dbaf29f74e9.jfif",
        category: "Arcade",
        description: "Happy Glass is a puzzle game where your mission is to cheer up a sad, empty glass by filling it with liquid! Draw lines to guide the stream of water into the glass and watch it smile as it fills up."
    },

  {
        ...
        thumbnail: "https://img.poki-cdn.com/cdn-cgi/image/quality=78,width=204,height=204,fit=cover,f=auto/0fdbf399b9c52aad46ce6a657a563b1b.png",
        category: "Arcade",
...

  {
        ...
        category: "Arcade",
        description: "Blaze Drifter is a thrilling 3D driving game where you aim to become the fastest driver on the road! Speed up, turn, drift, jump, and takedown—perform all the stunts and tricks to stay ahead!"
    },

  {
        ...
        category: "Arcade",
        description: "Hills of Steel is an action shooter game which puts you behind the wheel of a tank! Race and shoot your way through a hilled battlefield filled with enemies."
    },

  {
        ...
        category: "Arcade",
        description: "Kour.io is an online multiplayer FPS in which you will have to show who the best Kour really is! There's three different game modes to pick from;"
    },
];
